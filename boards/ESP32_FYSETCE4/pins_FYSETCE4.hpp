/**
 * @brief a pins configuration file for FYSETC E4 board
 */

#pragma once

// DRIVER_TYPE_TMC2209_UART requires 3 digital pins in Arduino pin numbering
// RA axis maps to X-MOTOR on FYSETC E4
#ifndef RA_STEP_PIN
...
// DRIVER_TYPE_TMC2209_UART requires 3 digital pins in Arduino pin numbering
// DEC axis maps to Y-MOTOR on FYSETC E4
#ifndef DEC_STEP_PIN
...
#endif
#ifndef DEC_TX_PIN
    #define DEC_TX_PIN 22
#endif
#ifndef DEC_RX_PIN
    #define DEC_RX_PIN 21
#endif
...
// DRIVER_TYPE_TMC2209_UART requires 3 digital pins in Arduino pin numbering
// AZ axis maps to Z-MOTOR on FYSETC E4
#ifndef AZ_STEP_PIN
...
// DRIVER_TYPE_TMC2209_UART requires 3 digital pins in Arduino pin numbering
// ALT axis maps to E0-MOTOR on FYSETC E4
#ifndef ALT_STEP_PIN
...
#endif
#ifndef ALT_TX_PIN
    #define ALT_TX_PIN 22
#endif
#ifndef ALT_RX_PIN
    #define ALT_RX_PIN 21
#endif
...
// Uses Serial2 with remapped pins: Z-MIN (GPIO 15) for TX, Y-MIN (GPIO 35) for RX
#ifndef GPS_SERIAL_PORT
    #define GPS_SERIAL_PORT Serial2
#endif
#ifndef GPS_TX_PIN
    #define GPS_TX_PIN 15  // Z-MIN endstop pin
#endif
#ifndef GPS_RX_PIN
    #define GPS_RX_PIN 35  // Y-MIN endstop pin
#endif
